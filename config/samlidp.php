...
return [
    ...
    'sp' => [
        'YXVkaW1hZ25hLnRlc3Q=' => [
            'destination' => 'audimagna.test',
            'logout' => 'audimagna.test/logout',
        ],
        'aHR0cHM6Ly9hdWRpbWFnbmEudGVzdC9zYW1sL2RlYWxlcg==' => [
            'destination' => 'https://audimagna.test/saml/dealer',
            'logout' => 'https://audimagna.test/logout',
        ]
